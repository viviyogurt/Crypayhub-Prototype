<template>
  <div id="app">
<!--      <tokenSwapModal-->
<!--              :account="allowAndTransferModal.senderAccount"-->
<!--              :contractAddress="allowAndTransferModal.selected"-->
<!--              :service="allowAndTransferModal.service"-->
<!--              :token-amount=allowAndTransferModal.tokenAmount>-->
<!--      </tokenSwapModal>-->

      <b-navbar toggleable="lg" type="dark" variant="dark">
          <b-navbar-brand href="/" class="mx-md-4 mx-2">Crypayhub</b-navbar-brand>
          <b-navbar-toggle target="nav-collapse"></b-navbar-toggle>

          <b-collapse id="nav-collapse" is-nav>
              <b-navbar-nav>
                  <b-nav-item-dropdown text="Coin Management" right>
                      <b-dropdown-item href="deposit" >Deposit</b-dropdown-item>
                      <b-dropdown-item href="withdraw">Withdraw</b-dropdown-item>
                      <b-dropdown-item href="tokenRegister">Token Register</b-dropdown-item>
                  </b-nav-item-dropdown>
                  <b-nav-item-dropdown text="Service" right>
                      <b-dropdown-item href="c2bPayment">Flash C2B Payment</b-dropdown-item>
                      <b-dropdown-item href="referralcommission">Referral Commission System</b-dropdown-item>
                      <b-dropdown-item href="subscription">Subscription System</b-dropdown-item>
                      <b-dropdown-item href="Demo" disabled>Revenue Splitter</b-dropdown-item>
                      <!--                    <b-dropdown-item href="account/Record">Account Record</b-dropdown-item>-->
                  </b-nav-item-dropdown>
                  <b-nav-item-dropdown text="Coin Market" right>
                      <b-dropdown-item href="https://faucet.matic.network/" target="_blank">Matic Coin Purchase</b-dropdown-item>
                      <b-dropdown-item href="Demo" disabled>CPHT Purchase</b-dropdown-item>
                      <b-dropdown-item href="Demo" disabled>CPHT Selling</b-dropdown-item>
                      <!--                    <b-dropdown-item href="account/Record">Account Record</b-dropdown-item>-->
                  </b-nav-item-dropdown>
<!--                  <b-nav-item href="merchant">Merchant</b-nav-item>-->
                  <b-nav-item href="dashboard">Dashboard</b-nav-item>
<!--                  <b-nav-item href="admin">Admin</b-nav-item>-->

                  <b-nav-item-dropdown text="Panel" right>
                      <b-dropdown-item href="merchant">Merchant</b-dropdown-item>
                      <b-dropdown-item href="admin">Admin</b-dropdown-item>
                  </b-nav-item-dropdown>

                  <b-nav-item href="https://docs.google.com/forms/d/1Wju8uGbkd2P5IYjWWwGBymVx-duB56VqEsSsqnEkBus" target="_blank">Merchant Register</b-nav-item>
              </b-navbar-nav>
          </b-collapse>
      </b-navbar>
...
<!--          <p class="text-center">Copyright 2021, @Nicholson. All Rights Reserved.</p>-->
<!--      </div>-->
  </div>
</template>
...
export default {
  ...
  //   },
  //   mounted(){
  //       this.$root.$on('showAllowAndTransferModal',(paramObj) => {
  //           // console.log('event receive: invalidTokenAmountAlert', isError);
  //           this.allowAndTransferModal = paramObj;
...
/*}*/
    ...
    .cardContainer{
        width: 1000px;
        box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.50), 0 6px 20px 0 rgba(0, 0, 0, 0.40);
    }
